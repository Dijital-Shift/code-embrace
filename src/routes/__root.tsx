...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://kingdomprotocol.app/og-card.jpg?v=4" },
      { property: "og:image:secure_url", content: "https://kingdomprotocol.app/og-card.jpg?v=4" },
      { property: "og:image:type", content: "image/jpeg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Kingdom Protocol — accountability with a watchman." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://kingdomprotocol.app/og-card.jpg?v=4" },
