...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Behavioral accountability through partner-based oversight." },
      { property: "og:title", content: "Kingdom Protocol" },
      { property: "og:description", content: "Behavioral accountability through partner-based oversight." },
