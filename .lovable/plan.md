...
1. **Homepage footer** (`src/routes/index.tsx`)
   - Replace `Built by Dijital Shift · v1.0` with `Dijital · System 2` (floating middle dot, not a period).
...
2. **Legal page footers**
   ...
   - Replace `Built by Dijital Shift` with `Dijital · System 2` (floating middle dot).

3. **Email template** (`src/lib/email-templates/_brand.tsx`)
   - Replace the credit line `Dijital System • 01` with `Dijital · System 2` (floating middle dot).
